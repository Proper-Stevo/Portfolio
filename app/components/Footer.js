...
<section class="bg-black">
    <div class="max-w-screen-xl px-4 py-12 mx-auto font-serif space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 space-x-6"> 
            <a href="http://www.github.com/Proper-Stevo" class="text-gray-400 hover:text-gray-500">
